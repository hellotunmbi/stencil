...
export async function createHttpServer(devServerConfig: d.DevServerConfig, destroys: d.DevServerDestroy[]) {
  ...
  const reqHandler = createRequestHandler(devServerConfig);
